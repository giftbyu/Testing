...
stt_pipeline = None
try:
    print("Memuat pipeline Whisper 'Large' (STT)... Ini akan mengunduh >1.5GB saat pertama kali.")
    ...
    print(f"Pipeline Whisper (STT) 'large' berhasil dimuat di perangkat {device}.")
except Exception as e:
